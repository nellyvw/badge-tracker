const PROCESS_TRAINING_DATA = {
  ...
  'andebrar': { processes: ['Dock', 'Stow', 'IB PS', 'Pick', 'Ship', 'Cubiscan'], pitProcesses: [], onsite: false },
  ...
  'ahmadrmo': { processes: ['Pick'], pitProcesses: [], onsite: false },
  ...
  'perxneil': { processes: ['Pack'], pitProcesses: [], onsite: false },
  ...
  'lsgursh': { processes: ['Stow'], pitProcesses: [], onsite: false },
